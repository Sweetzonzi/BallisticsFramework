...
- **护甲侧开发者**：进入[第三章 护甲侧开发](../3-护甲侧开发/3.1-实现TBHurtTarget.md)，深入了解 `ArmorLevel` 体系、每个管线方法的覆写策略、斜穿修正的默认实现和最终伤害计算的定制。如果是护甲物品开发者，直接看 [3.6 BFArmorMaterial 接口](../3-护甲侧开发/3.6-BFArmorMaterial接口.md)。
