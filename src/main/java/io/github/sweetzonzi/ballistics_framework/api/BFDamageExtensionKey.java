 ...
 * 通过 {@link BFDamageExtensions#register(ResourceLocation, Class, Supplier)} 创建。
...
public final class BFDamageExtensionKey<T> {
    ...
    BFDamageExtensionKey(ResourceLocation id, Class<T> type, Supplier<T> defaultValueFactory) {
